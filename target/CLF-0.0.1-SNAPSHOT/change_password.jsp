...
<head>
    ...
    <script charset="UTF-8" language="JavaScript" type="text/javascript" src="js/changepassword.js"></script>
</head>
<body>
<!-- 背景 -->
<div class="main_bg">
            ...
            <form class="register_form" method="post" action="" name="formreg">
                ...
                <div class="single_reg">
                    <table>
                        ...
                        <tr>
                            <th>用户名：</th>
                            <td><input type="text" name="username" id="username" disabled="true" style="border: none;background: #fff;"></td>
